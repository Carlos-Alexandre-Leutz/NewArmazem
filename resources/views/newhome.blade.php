        ...
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                @foreach($banners as $banner)
                    <div title="@if(strlen($banner->link)>0) Clique para visitar @endif"
                         class="carousel-item {{ $i==0?'active':'' }}" style="background-image: url('{{ asset('banner/' . $banner->image) }}')"
                         @if(strlen($banner->link)>0) data-link="{{$banner->link}} @endif">
...
<section class="products">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                @if($hasCategory)
                    <p id="back-container"><a class="btn-link" id="verCategorias" href="{{ url('/') }}"><i class="fas fa-arrow-left"></i> Categorias</a></p>
